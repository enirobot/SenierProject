...
import com.team.news.Repository.BubbleRepository2;
...
public class BubbleController {
    ...
    private final BubbleRepository2 bubbleRepository2;
    private MainNewsListRepository mainNewsListRepository;

    @Autowired
    public BubbleController(BubbleRepository2 graphRepository, MainNewsListRepository mainNewsListRepository) {
        this.mainNewsListRepository = mainNewsListRepository;
        this.bubbleRepository2 = graphRepository;
    }
